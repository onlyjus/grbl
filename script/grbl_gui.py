...
class gui:
    def __init__(self, parent):
        parent.geometry("600x600+300+300")
        ...
        self.manGcodeFrame=tk.Frame(self.gcodeControlFrame)
        self.manGcodeFrame.pack(expand=True, fill=tk.X)
        tk.Label(self.manGcodeFrame, text='Manual:').pack(side=tk.LEFT, pady=5, padx=2)
        tk.Entry(self.manGcodeFrame).pack(side=tk.LEFT, pady=5, padx=2, expand=True, fill=tk.X)
        tk.Button(self.manGcodeFrame, text='Send').pack(side=tk.LEFT, pady=5, padx=2)

        self.sendFileFrame=tk.Frame(self.gcodeControlFrame)
        self.sendFileFrame.pack(expand=True, fill=tk.X)
        tk.Button(self.sendFileFrame, text='Send Gcode File').pack(side=tk.LEFT, pady=5, padx =2)
        ttk.Progressbar(self.sendFileFrame).pack(side=tk.LEFT, expand=True, fill=tk.X, pady=5, padx=2)
